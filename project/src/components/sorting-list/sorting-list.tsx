...
function SortingList(): JSX.Element {
  ...
  const sortSelectHandler = (evt: MouseEvent<HTMLLIElement>) => {
  ...
  return (
    <form className="places__sorting" action="#" method="get">
      ...
      <ul className={isActive ? 'places__options places__options--custom places__options--opened' : 'places__options places__options--custom places__options--closed'}>
        <li className="places__option" data-tag={'Popular'} tabIndex={0} onClick ={sortSelectHandler}>Popular</li>
        <li className="places__option" data-tag={'Price: low to high'} tabIndex={0} onClick ={sortSelectHandler}>Price: low to high</li>
        <li className="places__option" data-tag={'Price: high to low'} tabIndex={0} onClick ={sortSelectHandler}>Price: high to low</li>
        <li className="places__option" data-tag={'Top rated first'} tabIndex={0} onClick ={sortSelectHandler}>Top rated first</li>
      </ul>
    </form>
  );
}
